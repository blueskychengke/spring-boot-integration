...
import com.example.generator.generator.bean.EntityOfEntity;
...
public class XbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String description = "first";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Czs";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.example.generator.base.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.example.generator.base.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.example.generator.base.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.example.generator.base.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.example.generator.base.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
      // C:\Users\Administrator\IdeaProjects\generator
        String root = System.getProperty("user.dir")+"/src/main/java/com/example/generator/generator/template";
